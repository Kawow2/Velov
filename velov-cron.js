...
async function insertStationStatus(statusUrl) {
  ...
  const rows = stations.map((s) => ({
    ...
    num_bikes_mechanical: s.num_bikes_available_types?.mechanical ?? 0,
    num_bikes_ebike: s.num_bikes_available_types?.ebike ?? 0,
  ...
  console.log("Stations status récupérées:", rows.length);
